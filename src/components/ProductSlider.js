           ...
           lg:grid-cols-4 lg:gap-[30px]'>
              {page.productList.map((product,index)=>{
                ...
                <div className=' w-full max-w-[290px] h-[380px] text-left  ]' key={index}>
                 <div className='border hover:border-accent rounded-[18px]
                 w-full max-w-[280px] rounded-[18px] h-full max-h-[290px] flex  justify-center items-center
                  mb-[15px] relative-transition'>
                  <img className='object-cover w-full h-full rounded-[18px]' src={image.type} alt=''/>
                  <div className='absolute ml-[117px] mt-[220px] mr-15 bg-gray-100 w-8 h-8 rounded-full flex justify-center
                   items-center cursor-pointer hover:bg-gray-200 transition'>
